...
if __name__ == "__main__" :
    ...
    label1 = Label(root, text = "Principle Amount(Rs) : ", fg = 'white', bg = 'gray')
   
    # Create a Rate : label
    label2 = Label(root, text = "Rate(%) : ", fg = 'white', bg = 'gray')
       
    # Create a Time : label
    label3 = Label(root, text = "Time(years) : ", fg = 'white', bg = 'gray')
 
    # Create a Compound Interest : label
    label4 = Label(root, text = "Compound Interest : ", fg = 'white', bg = 'gray')
    ...
    button1 = Button(root, text = "Submit", bg = "gray", fg = "white", command = calculate_ci)
   
    # Create a Clear Button and attached 
    # to clear_all function 
    button2 = Button(root, text = "Clear", bg = "gray", fg = "white", command = clear_all)
