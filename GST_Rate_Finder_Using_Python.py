...
if __name__ == "__main__" :
	...
	org_price = Label(gui, text = "Original Price", bg = "gray", fg = "white")
	
	# Create a Net Price : label
	net_price = Label(gui, text = "Net Price", bg = "gray", fg = "white")

	# Create a Find Button and attached to findGst function
	find = Button(gui, text = "Find", fg = "white", bg = "green", command = findGst)
	
	# Create a Gst Rate : label
	gst_rate = Label(gui, text = "Gst Rate", bg = "gray", fg = "white")
