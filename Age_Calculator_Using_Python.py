...
def calculateAge() :
	...
	if value == -1 :
		...
		# if birth date is greater then given birth_month then donot count this month
		...
		# if birth month exceeds given month, then donot count this year and add 12 to the
...
if __name__ == "__main__" :
	...
	dob = Label(gui, text = "Date Of Birth", bg = "light gray")

	# Create a Given Date : label
	givenDate = Label(gui, text = "Given Date", bg = "light gray")
